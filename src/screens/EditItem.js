...
const EditItem = ({navigation}) => {
  const route = useRoute(); //Data wii be same as it was before
  ...
  const uploadItem = () => {
    firestore()
      ...
      .then(() => {
        ...
        navigation.goBack(); //Once data is updated used to again go back to screen
      });
  };
    ...
    <ScrollView style={styles.container}>
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          <Text style={{color: 'black'}}>Update Item</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
