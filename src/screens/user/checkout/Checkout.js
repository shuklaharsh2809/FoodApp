  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.totalView}>
          <Text style={styles.nameText}>Selected Adress</Text>
          <Text
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                selectedAddress == 'No Selected Address'
                  ? '#DADADA'
                  : 'skyblue',
            },
          ]}
...
const styles = StyleSheet.create({
  ...
  checkoutBtn: {
    ...
    alignItems: 'center',
    marginTop: 40,
    marginBottom: 20, // Add this to give some space from the bottom
  },
});
